# Generated by Django 4.2.16 on 2026-04-12 15:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmer_number', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('name', models.CharField(max_length=255, null=True)),
                ('phone', models.CharField(max_length=255, null=True, unique=True)),
                ('secondary_phone', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('refferal', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('payment_mode', models.CharField(choices=[(1, 'Cash'), (2, 'Mpesa'), (3, 'KCB'), (4, 'Equity'), (5, 'Almanis Tier A'), (6, 'Almanis Tier B'), (7, 'Others')], max_length=255)),
                ('kilos', models.CharField(default=0, max_length=255)),
                ('payment', models.CharField(max_length=255)),
                ('amount', models.CharField(default=0, max_length=255)),
                ('price', models.CharField(default=2.5, max_length=255)),
                ('receipt_number', models.CharField(default=0, max_length=255)),
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('farmer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='barakaApp.farmer')),
